# Methods: Brooke's Spotify data variable creation

## Background

Brooke created three new variables from the Spotify data. See @tbl-1 for descriptives of the three new variables. Below outlines the steps that were taken to create them.
